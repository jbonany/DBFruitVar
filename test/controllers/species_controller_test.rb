...
class SpeciesControllerTest < ActionController::TestCase
  ...
  test "should create species" do
    assert_difference('Species.count') do
      post :create, species: { acronym: @species.acronym, latinname: @species.latinname, name: @species.name }
    end
  ...
  test "should update species" do
    patch :update, id: @species, species: { acronym: @species.acronym, latinname: @species.latinname, name: @species.name }
    assert_redirected_to species_path(assigns(:species))
  end
